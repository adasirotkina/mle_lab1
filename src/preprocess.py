...
class DataMaker():
    ...
    def __init__(self) -> None:
        ...
        self.train_path = [os.path.join(self.project_path, "Train_bike_X.csv"), os.path.join(
            self.project_path, "Train_bike_y.csv")]
        self.test_path = [os.path.join(self.project_path, "Test_bike_X.csv"), os.path.join(
            self.project_path, "Test_bike_y.csv")]
